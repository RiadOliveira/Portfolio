...
export function LayoutContainer({ children }: DefaultProps) {
  return (
    <div className="animated-gradient flex h-screen flex-col p-2.5">
      ...
      <main className="bg-light/27 dark:bg-dark/32.5 relative flex h-full max-h-full flex-col overflow-y-hidden rounded-lg px-4 pt-3 transition-colors duration-300">
