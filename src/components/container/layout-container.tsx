...
export function LayoutContainer({ children }: DefaultProps) {
  return (
    <div className="animated-gradient flex h-dvh flex-col p-2.5">
      <HeaderContainer />

      <main className="bg-light/27 dark:bg-dark/32.5 relative flex flex-1 flex-col overflow-y-hidden rounded-lg px-4 py-3 transition-colors duration-300">
