...
export function ModalContainer({
  ...
  return (
    <dialog id={MODAL_ID} {...props} className="animated-modal">
      <div className="bg-light dark:bg-dark text-dark dark:text-light relative mx-auto mt-2 flex h-[calc(100%-1rem)] w-[calc(100%-1rem)] flex-col rounded-xl shadow-md ring-2 ring-emerald-400/70 lg:w-[700px]">
